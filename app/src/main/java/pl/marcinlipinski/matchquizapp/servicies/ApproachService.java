...
public class ApproachService implements Service<Approach> {
    ...
    public static Approach getTemporaryApproach() {
        return ApproachService.approach;
    }

    public static void resetTemporaryApproach() {
        ApproachService.approach = new Approach();
    }
